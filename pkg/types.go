...
type URLTokenMatcher = string

const (
	URLTokenMatcherID                 URLTokenMatcher = "{ID}"
	URLTokenMatcherPublicID           URLTokenMatcher = "{publicID}"
	URLTokenMatcherExternalID         URLTokenMatcher = "{externalID}"
	URLTokenMatcherCost               URLTokenMatcher = "{cost}"
	URLTokenMatcherRevenue            URLTokenMatcher = "{revenue}"
	URLTokenMatcherViewTime           URLTokenMatcher = "{viewTime}"
	URLTokenMatcherClickTime          URLTokenMatcher = "{clickTime}"
	URLTokenMatcherConvTime           URLTokenMatcher = "{convTime}"
	URLTokenMatcherViewOutputUrl      URLTokenMatcher = "{viewOutputUrl}"
	URLTokenMatcherClickOutputUrl     URLTokenMatcher = "{clickOutputUrl}"
	URLTokenMatcherIP                 URLTokenMatcher = "{ip}"
	URLTokenMatcherIsp                URLTokenMatcher = "{isp}"
	URLTokenMatcherUserAgent          URLTokenMatcher = "{userAgent}"
	URLTokenMatcherLanguage           URLTokenMatcher = "{language}"
	URLTokenMatcherCountry            URLTokenMatcher = "{country}"
	URLTokenMatcherRegion             URLTokenMatcher = "{region}"
	URLTokenMatcherCity               URLTokenMatcher = "{city}"
	URLTokenMatcherDeviceType         URLTokenMatcher = "{deviceType}"
	URLTokenMatcherDevice             URLTokenMatcher = "{device}"
	URLTokenMatcherScreenResolution   URLTokenMatcher = "{screenResolution}"
	URLTokenMatcherOs                 URLTokenMatcher = "{os}"
	URLTokenMatcherOsVersion          URLTokenMatcher = "{osVersion}"
	URLTokenMatcherBrowserName        URLTokenMatcher = "{browserName}"
	URLTokenMatcherBrowserVersion     URLTokenMatcher = "{browserVersion}"
	URLTokenMatcherCreatedAt          URLTokenMatcher = "{createdAt}"
	URLTokenMatcherUpdatedAt          URLTokenMatcher = "{updatedAt}"
	URLTokenMatcherAffiliateNetworkID URLTokenMatcher = "{affiliateNetworkId}"
	URLTokenMatcherCampaignID         URLTokenMatcher = "{campaignId}"
	URLTokenMatcherFlowID             URLTokenMatcher = "{flowId}"
	URLTokenMatcherLandingPageID      URLTokenMatcher = "{landingPageId}"
	URLTokenMatcherOfferID            URLTokenMatcher = "{offerId}"
	URLTokenMatcherTrafficSourceID    URLTokenMatcher = "{trafficSourceId}"
)
